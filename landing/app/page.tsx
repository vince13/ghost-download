          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 hover:border-blue-500/50 transition-colors">
                ...
                <a
                  href="https://github.com/vince13/ghost-download/releases/download/v0.1.0/ghost-0.1.0-arm64.dmg"
                ...
                <a
                  href="https://github.com/vince13/ghost-download/releases/download/v0.1.0/ghost-0.1.0-arm64-mac.zip"
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 hover:border-blue-500/50 transition-colors">
                ...
                <a
                  href="https://github.com/vince13/ghost-download/releases/download/v0.1.0/ghost Setup 0.1.0.exe"
                  className="block w-full px-4 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-center font-medium transition-colors flex items-center justify-center gap-2"
                >
                  <Download className="w-4 h-4" />
                  Download Installer
                ...
                <a
                  href="https://github.com/vince13/ghost-download/releases/download/v0.1.0/ghost-0.1.0-win-portable.exe"
                  className="block w-full mt-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg text-center text-sm transition-colors"
                >
                  Download Portable
                </a>
